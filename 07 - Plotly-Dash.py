...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, 
                    ...
                    names = [1,0],
                    title="Success Rate for site {fname}".format(fname = entered_site))
        return fig       
...
def get_payload_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(
            ...
            title='Payload Mass for all sites'
        )
        return fig
    else:
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig = px.scatter(
            ...
            range_x = payload_range,
            color="Booster Version Category",
            title="Payload Mass for site {fname}".format(fname=entered_site)
        )
        return fig
